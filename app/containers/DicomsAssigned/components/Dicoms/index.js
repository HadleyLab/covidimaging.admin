...
import { DICOM_FILTER_ASSIGNED } from '../../constants';
...
class DicomsStep extends PureComponent {
    ...
    assignUserForDicomFiles = () => {
        const { onAssignUser, users} = this.props;
        const { transferIDByDicom, activDicomID, userIDByDicom} = this.state;

        const { onAssignTransfer } = this.props;
                    ...
                    <AppBar position="static" color="default" className={classes.bar}>
                        <Toolbar>
                            <Typography variant="title" className={classes.flex}>
                                {trans('admin.panel.DICOMs.title.assigned')}
                            </Typography>
                        </Toolbar>
                    </AppBar>
                        ...
                        <Table className={classes.table}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <CustomTableCell numeric>{trans('admin.panel.DICOMs.user')}</CustomTableCell>
